...
<template>
    ...
    >
        <div class="w-full py-6">
            ...
            <div class="mt-16">
                <nav class="border-b border-t border-gray-400 py-2">
                    <nav-link href="/">Home</nav-link>
                    <nav-link href="/appetizer">Appetizer</nav-link>
                    <nav-link href="/main-dish">Main Dish</nav-link>
                    <nav-link href="/dessert">Dessert</nav-link>
                </nav>
            </div>

            <div class="flex m-6">
                <div class="border-2 border-gray-400 flex-1 p-4">

                    <recipe-item v-for="recipe in recipes" :key="recipes.id" :recipe="recipe" />
                </div>
                <div class="pl-6">
                    <button class="w-full text-lg text-red-600 bg-blue-400 hover:bg-blue-300 transition-all ease-in px-4 py-2 font-bold">Submit A Recipe</button>
                    <featured-recipe/>
                </div>
            </div>
        </div>
